...
import com.example.infinitelearningfrontend.Navigation.NavigationItem
import com.example.infinitelearningfrontend.Navigation.Screen
import com.example.infinitelearningfrontend.R
import com.example.infinitelearningfrontend.presentation.component.shareItem
...
fun FrontEnd(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Front End Infinite Learning") },
                actions = {
        ...
        NavHost(
            ...
            composable(
                Screen.Detail.route + "/{gymId}",
                arguments = listOf(navArgument("gymId") { type = NavType.IntType })
            ) { navBackStackEntry ->
                DetailGymScreen(
                    navController = navController,
                    gymsId = navBackStackEntry.arguments?.getInt("gymId")
                )
            }
        }
    }
